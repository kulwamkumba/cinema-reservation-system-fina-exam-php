            ...
            <div class="booking-form-container">
                <form action="" method="POST">
                    ...
                    <select name="date" required>
                        ...
                        <option value="12-3">August 09,2020</option>
                        <option value="13-3">August 10,2020</option>
                        <option value="14-3">August 11,2020</option>
                        <option value="15-3">August 12,2020</option>
                        <option value="16-3">August 13,2020</option>
                    </select>
